...
ENTITIES_DICT: Dict[str, Dict[str, Any]] = {
    ...
    C_TEMP_AUSSEN: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. outdoor","REG":10,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 0"},
    C_TEMP_BRAUCHWASSER: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. DHW","REG":11,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 2"},
    C_TEMP_VORLAUF: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. flow","REG":12,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 3"},
    C_TEMP_RUECKLAUF: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. return","REG":13,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 4"},
    C_TEMP_PUFFERSPEICHER: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. buffer tank","REG":14,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 5"},
    C_TEMP_EQ_EINTRITT: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. EQ inlet","REG":15,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 6"},
    C_TEMP_EQ_AUSTRITT: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. EQ outlet","REG":16,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 7"},
    C_TEMP_SAUGGAS: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. suction gas","REG":17,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 9"},
    C_TEMP_VERDAMPFUNG: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. evaporating","REG":18,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 12"},
    C_TEMP_KONDENSATION: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. condensing","REG":19,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 13"},
    C_TEMP_HEISSGAS: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. hot gas","REG":20,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 15"},
    C_NIEDERDRUCK: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Low pressure","REG":21,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"bar","WEB_ID":"MP 20"},
    C_HOCHDRUCK: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"High pressure","REG":22,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"bar","WEB_ID":"MP 21"},
    C_HEIZKREISPUMPE: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Heating circuit pump","REG":23,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 22"},
    C_PUFFERLADEPUMPE: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Buffer loading pump","REG":24,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 23"},
    C_VERDICHTER: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Compressor","REG":25,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 30"},
    C_STOERUNG: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Störung","REG":26,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 31"},
    C_VIERWEGENVENTIL_ABTAUBETRIEB: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Reversing valve (defrost)","REG":27,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 32"},
    C_WMZ_DURCHFLUSS: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"WMZ flow","REG":28,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"l/min","WEB_ID":"MP 85"},
    C_N_SOLL_VERDICHTER: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"n-target compressor","REG":29,"DT":C_DT_INT16,"FAKTOR":1,"UNIT":"‰","WEB_ID":"MP 90"},
    C_COP: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"COP","REG":30,"DT":C_DT_INT16,"FAKTOR":0.1,"WEB_ID":"MP 92"},
    C_TEMP_FRISCHWASSER: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. fresh water","REG":31,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 11"},
    C_EVU_SPERRE_AKTIV: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Utility company block active","REG":32,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 37"},
    C_TEMP_AUSSEN_VERZOEGERT: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Temp. outside (delayed)","REG":33,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 1"},
    C_HKR_SOLLTEMP: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"HKR SP temp.","REG":34,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 57"},
    C_MKR1_SOLLTEMP: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"MKR1 SP temp.","REG":35,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 66"},
    C_MKR2_SOLLTEMP: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"MKR2 SP temp.","REG":36,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 72"},
    C_EQ_VENTILATOR_PUMPE: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Aircoil fan","REG":37,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 24"},
    C_WW_VORRANG_WW: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"WW Vorrang WW","REG":38,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 25"},
    C_KUEHLEN_UMV_PASSIV: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Passive cooling","REG":39,"DT":C_DT_INT16,"SWITCH":{"off":0},"WEB_ID":"MP 27"},
    C_EXPANSIONSVENTIL: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Expansion valve","REG":40,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"‰","WEB_ID":"MP 51"},
    ...
    C_BETRIEBSSTUNDEN_IM_WW_BETRIEB: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Compressor requirement im WW-Betrieb","REG":42,"DT":C_DT_UINT32,"FAKTOR":1,"UNIT":"h","WEB_ID":"SP 171"},
    C_BETRIEBSSTUNDEN_IM_HZG_BETRIEB: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Compressor requirement im HZG-Betrieb","REG":44,"DT":C_DT_UINT32,"FAKTOR":1,"UNIT":"h","WEB_ID":"SP 172"},
    C_MKR1_VORLAUFTEMPERATUR: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"MKR1 flow temp.","REG":46,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 63"},
    C_MKR1_RUECKLAUFTEMPERATUR: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"MKR1 return temp.","REG":47,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","WEB_ID":"MP 64"},
    ...
    C_STROMZAEHLER_HEIZUNG: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Stromzähler Heizung","REG":62,"DT":C_DT_UINT32,"FAKTOR":1,"UNIT":"kWh","WEB_ID":"MP 53"},
    C_WMZ_BRAUCHWASSER: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"WMZ Brauchwasser","REG":64,"DT":C_DT_UINT32,"FAKTOR":1,"UNIT":"kWh","WEB_ID":"MP 54"},
    C_STROMZAEHLER_BRAUCHWASSER: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Electricity meter DHW","REG":66,"DT":C_DT_UINT32,"FAKTOR":1,"UNIT":"kWh","WEB_ID":"MP 55"},
    C_STROMZAEHLER_GESAMT: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Electricity meter total Gesamt","REG":68,"DT":C_DT_UINT32,"FAKTOR":1,"UNIT":"kWh","WEB_ID":"MP 75"},
    C_STROMZAEHLER_LEISTUNG: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"Electricity meter output","REG":70,"DT":C_DT_UINT32,"FAKTOR":1,"UNIT":"W","WEB_ID":"MP 83"},
    C_WMZ_GESAMT: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"WMZ Total","REG":72,"DT":C_DT_UINT32,"FAKTOR":1,"UNIT":"kWh","WEB_ID":"MP 84"},
    C_WMZ_LEISTUNG: {"RT": C_REG_TYPE_INPUT_REGISTERS,"NAME":"WMZ Now","REG":74,"DT":C_DT_UINT32,"FAKTOR":0.1,"UNIT":"kW","WEB_ID":"MP 89"},
    # --- 76-99 werden aktuell nicht genutzt ---
    # HOLDING_REGISTERS
    C_BETRIEBSART: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Operating mode","REG":100,"DT":C_DT_UINT16,"VALUES":{0:"Off",1:"Automatic",2:"Cooling",3:"Summer",4:"Continous operation",5:"Setback",6:"Holiday",7:"Party","default":1},"WEB_ID":"SP 13"},
    ...
    C_WW_MINIMALTEMPERATUR: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"DHW minimum temperature","REG":106,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":1.0,"MIN":5.0,"MAX":65.0,"WEB_ID":"SP 85","PF":Platform.NUMBER},
    C_MKR1_BETRIEBSART: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 Operating mode","REG":107,"DT":C_DT_UINT16,"VALUES":{0:"Aus",1:"Automatik",2:"Kühlen",3:"Sommer",4:"Dauerbetrieb",5:"Absenkbetrieb",6:"Urlaub",7:"Party","default":1},"WEB_ID":"SP 221"},
    C_MKR1_RAUMSOLLTEMPERATUR: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 Room target temperature","REG":108,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":0.5,"MIN":10.0,"MAX":25.0,"WEB_ID":"SP 200","PF":Platform.NUMBER},
    C_MKR1_SOLLTEMPERATUR: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 Target temperature","REG":109,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":0.5,"MIN":5.0,"MAX":65.0,"HA":C_MKR1_SOLLTEMPERATUR_HAND_AKTIV,"WEB_ID":"MP 66","PF":Platform.NUMBER},
    C_MKR1_SOLLTEMPERATUR_HAND_AKTIV: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 Target temperature hand/auto","REG":110,"DT":C_DT_UINT16,"SWITCH":{"off":0,"on":1},"WEB_ID":"MP 66"},
    C_MKR1_MIN_RUECKLAUFTEMPERATUR_KUEHLEN: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 min return temperature (cooling)","REG":111,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":1.0,"MIN":15.0,"MAX":25.0,"WEB_ID":"SP 348","PF":Platform.NUMBER},
    C_MKR2_BETRIEBSART: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 Operating mode","REG":112,"DT":C_DT_UINT16,"VALUES":{0:"Aus",1:"Automatik",2:"Kühlen",3:"Sommer",4:"Dauerbetrieb",5:"Absenkbetrieb",6:"Urlaub",7:"Party","default":1},"WEB_ID":"SP 244","PF":Platform.NUMBER},
    C_MKR2_RAUMSOLLTEMPERATUR: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 room setpoint temp.","REG":113,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":0.5,"MIN":10.0,"MAX":25.0,"WEB_ID":"SP 223","PF":Platform.NUMBER},
    C_MKR2_SOLLTEMPERATUR: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 Target temperature","REG":114,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":0.5,"MIN":5.0,"MAX":65.0,"HA":C_MKR2_SOLLTEMPERATUR_HAND_AKTIV,"WEB_ID":"MP 72","PF":Platform.NUMBER},
    C_MKR2_SOLLTEMPERATUR_HAND_AKTIV: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 Target temperature hand/auto","REG":115,"DT":C_DT_UINT16,"SWITCH":{"off":0,"on":1},"WEB_ID":"MP 72"},
    C_MKR2_MIN_RUECKLAUFTEMPERATUR_KUEHLEN: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 min return temperature (cooling)","REG":116,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":1.0,"MIN":15.0,"MAX":25.0,"WEB_ID":"SP 352","PF":Platform.NUMBER},
    C_PV_ANFORDERUNG: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"PV Requirement","REG":117,"DT":C_DT_UINT16,"SWITCH":{"off":0,"on":1},"WEB_ID":"SP 436"},
    C_PV_HEIZEN_OFFSET: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"PV Heating Offset","REG":118,"DT":C_DT_UINT16,"FAKTOR":0.1,"UNIT":"K","STEP":0.1,"MIN":0.0,"MAX":10.0,"WEB_ID":"SP 437","PF":Platform.NUMBER},
    C_PV_KUEHLEN_OFFSET: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"PV Cooling Offset","REG":119,"DT":C_DT_UINT16,"FAKTOR":0.1,"UNIT":"K","STEP":0.1,"MIN":0.0,"MAX":10.0,"WEB_ID":"SP 438","PF":Platform.NUMBER},
    C_PV_HEIZEN_OFFSET_MKR1: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"PV Heating Offset MKR1","REG":120,"DT":C_DT_UINT16,"FAKTOR":0.1,"UNIT":"K","STEP":0.1,"MIN":0.0,"MAX":10.0,"WEB_ID":"SP 453","PF":Platform.NUMBER},
    C_PV_KUEHLEN_OFFSET_MKR1: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"PV Cooling Offset MKR1","REG":121,"DT":C_DT_UINT16,"FAKTOR":0.1,"UNIT":"K","STEP":0.1,"MIN":0.0,"MAX":10.0,"WEB_ID":"SP 454","PF":Platform.NUMBER},
    C_PV_HEIZEN_OFFSET_MKR2: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"PV Heating Offset MKR2","REG":122,"DT":C_DT_UINT16,"FAKTOR":0.1,"UNIT":"K","STEP":0.1,"MIN":0.0,"MAX":10.0,"WEB_ID":"SP 455","PF":Platform.NUMBER},
    C_PV_KUEHLEN_OFFSET_MKR2: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"PV Cooling Offset MKR2","REG":123,"DT":C_DT_UINT16,"FAKTOR":0.1,"UNIT":"K","STEP":0.1,"MIN":0.0,"MAX":10.0,"WEB_ID":"SP 456","PF":Platform.NUMBER},
    ...
    C_VORGABE_LEISTUNGSAUFNAHME: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Specified power consumtpion","REG":125,"DT":C_DT_UINT16,"FAKTOR":1,"UNIT":"W","STEP":1,"MIN":0,"MAX":7000,"PF":Platform.NUMBER},   #MAX-Wert hängt von der LEistung der WP ab -> konfigurierbar machen?
    C_VORGABE_VERDICHTERDREHZAHL: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Set compressor speed","REG":126,"RW":0,"DT":C_DT_INT16,"FAKTOR":1,"UNIT":"‰","STEP":1,"MIN":0,"MAX":1000,"PF":Platform.NUMBER},  #!! DARF NICHT BESCHRIEBEN WERDEN
    C_EXT_ANFORDERUNG: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"External requirementEntstören","REG":127,"DT":C_DT_UINT16,"SWITCH":{"off":0,"on":1},"WEB_ID":"MP 27"},
    C_ENTSTOEREN: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Entstören","REG":128,"DT":C_DT_UINT16,"SWITCH":{"off":0,"on":1},"WEB_ID":"SP 14"},
    C_AUSSENTEMPERATUR_HANDWERT: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Outside temperature hand value","REG":129,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":0.1,"MIN":-49.9,"MAX":60.0,"HA":C_AUSSENTEMPERATUR_HAND_AKTIV,"WEB_ID":"MP 0","PF":Platform.NUMBER},
    C_AUSSENTEMPERATUR_HAND_AKTIV: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Outside temperature hand/auto","REG":130,"DT":C_DT_UINT16,"SWITCH":{"off":0,"on":1},"WEB_ID":"MP 0"},
    C_PUFFERTEMPERATUR_HANDWERT: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Buffer temperature hand value","REG":131,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":0.1,"MIN":5.0,"MAX":60.0,"HA":C_PUFFERTEMPERATUR_HAND_AKTIV,"WEB_ID":"MP 5","PF":Platform.NUMBER},
    C_PUFFERTEMPERATUR_HAND_AKTIV: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Buffer temperature hand/auto","REG":132,"DT":C_DT_UINT16,"SWITCH":{"off":0,"on":1},"WEB_ID":"MP 5"},
    C_BRAUCHWASSERTEMPERATUR_HANDWERT: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"DHW temperature hand value","REG":133,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","STEP":0.1,"MIN":5.0,"MAX":60.0,"HA":C_BRAUCHWASSERTEMPERATUR_HAND_AKTIV,"WEB_ID":"MP 2","PF":Platform.NUMBER},
    C_BRAUCHWASSERTEMPERATUR_HAND_AKTIV: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"DHW temperature hand/auto","REG":134,"DT":C_DT_UINT16,"SWITCH":{"off":0,"on":1},"WEB_ID":"MP 2"},
    C_HKR_HEIZGRENZE: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"HKR Heating limit","REG":135,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","Step": 1.0, "MIN":5.0,"MAX":30.0,"WEB_ID":"SP 76","PF":Platform.NUMBER},
    C_HKR_RUECKLAUFSOLL_BEI_HEIZGRENZE: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"HKR Return temperature SP at heating limit","REG":136,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 80","PF":Platform.NUMBER},
    C_HKR_RUECKLAUFSOLL_BEI_0_C: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"HKR Return temperature SP at 0°C","REG":137,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 81","PF":Platform.NUMBER},
    C_HKR_RUECKLAUFSOLL_BEI_15_C: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"HKR Return temperature SP at -15°C","REG":138,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 82","PF":Platform.NUMBER},
    C_MKR1_HEIZGRENZE: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 Heating limit","REG":139,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","Step": 1, "MIN":5.0,"MAX":30.0,"WEB_ID":"SP 205","PF":Platform.NUMBER},
    C_MKR1_RUECKLAUFSOLL_BEI_HEIZGRENZE: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 Return temperature SP at heating limit","REG":140,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 209","PF":Platform.NUMBER},
    C_MKR1_RUECKLAUFSOLL_BEI_0_C: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 Return temperature SP at 0°C","REG":141,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 210","PF":Platform.NUMBER},
    C_MKR1_RUECKLAUFSOLL_BEI_15_C: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR1 Return temperature SP at -15°C","REG":142,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 211","PF":Platform.NUMBER},
    C_MKR2_HEIZGRENZE: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 Heating limit","REG":143,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","Step": 1, "MIN":5.0,"MAX":30.0,"WEB_ID":"SP 228","PF":Platform.NUMBER},
    C_MKR2_RUECKLAUFSOLL_BEI_HEIZGRENZE: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 Return temperature SP at heating limit","REG":144,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 232","PF":Platform.NUMBER},
    C_MKR2_RUECKLAUFSOLL_BEI_0_C: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 Return temperature SP at 0°C","REG":145,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 233","PF":Platform.NUMBER},
    C_MKR2_RUECKLAUFSOLL_BEI_15_C: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"MKR2 Return temperature SP at -15°C","REG":146,"DT":C_DT_INT16,"FAKTOR":0.1,"UNIT":"°C","MIN":15.0,"MAX":35.0,"WEB_ID":"SP 234","PF":Platform.NUMBER},
...
def _unit_mapping(
    ...
    # Energie & Leistung
    if u.lower() in {"kwh", "kWh".lower()}:  # akzeptiere beide Schreibweisen
        return (
