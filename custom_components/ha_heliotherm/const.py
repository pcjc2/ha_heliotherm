...
ENTITIES_DICT: Dict[str, Dict[str, Any]] = {
    ...
    C_VORGABE_VERDICHTERDREHZAHL: {"RT": C_REG_TYPE_HOLDING_REGISTERS,"NAME":"Vorgabe Verdichterdrehzahl","REG":126,"RW":1,"DT":C_DT_INT16,"FAKTOR":1,"UNIT":"‰","STEP":1,"MIN":0,"MAX":1000,"PF":Platform.NUMBER},  #!! DARF NICHT BESCHRIEBEN WERDEN
